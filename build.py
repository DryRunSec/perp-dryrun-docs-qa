...
<p>From the DeepScan page, click on a previously scanned repository to see findings from the latest DeepScan. To review past scans, use the date picker at the top of the page and select the date of a previous scan.</p>
<p>Clicking on an individual finding opens a pop-out module showing the finding detail, the DeepScan summary, and any artifact files associated with that finding. The &ldquo;View Details&rdquo; button shows app-specific summaries for the full scan, including auth methods, APIs, configurations, and other context discovered during the scan.</p>
...
<table>
  ...
  <tbody>
    <tr><td>JavaScript / Node.js</td><td><code>package.json</code>, <code>package-lock.json</code>, <code>yarn.lock</code></td></tr>
    <tr><td>Python</td><td><code>requirements.txt</code>, <code>Pipfile</code>, <code>pyproject.toml</code>, <code>poetry.lock</code></td></tr>
    <tr><td>Ruby</td><td><code>Gemfile</code>, <code>Gemfile.lock</code></td></tr>
    <tr><td>Java / Kotlin</td><td><code>pom.xml</code>, Gradle build files</td></tr>
    <tr><td>Go</td><td><code>go.mod</code>, <code>go.sum</code></td></tr>
    <tr><td>Rust</td><td><code>Cargo.toml</code>, <code>Cargo.lock</code></td></tr>
    <tr><td>.NET</td><td><code>*.csproj</code>, <code>packages.config</code></td></tr>
  </tbody>
</table>
